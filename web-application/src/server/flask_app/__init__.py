...
from .routes import polygons, incomes, flats_rental, transport, twitter, recommendation, test, report, explore_heat
import os
...
BLUEPRINTS = (polygons, incomes, flats_rental, transport, twitter, recommendation, test, explore_heat, report)
