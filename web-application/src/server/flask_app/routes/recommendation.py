...
def calculate_recommendation():
    ...
    data = filter_neighbourhood(max_transport_time, min_rental_price, max_rental_price, night_live, transport_cost,lat,lng)
...
def filter_neighbourhood(max_transport_time, min_rental_price, max_rental_price, night_live,transport_cost, lat, lng):
